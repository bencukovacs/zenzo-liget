...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Selected Starter: create-next-app with Manual Enhancements](./starter-template-evaluation.md#selected-starter-create-next-app-with-manual-enhancements)
    - [Architectural Decisions Provided by Starter](./starter-template-evaluation.md#architectural-decisions-provided-by-starter)
    - [Post-Creation Setup Required](./starter-template-evaluation.md#post-creation-setup-required)
  ...
  - [Implementation Patterns & Consistency Rules](./implementation-patterns-consistency-rules.md)
    ...
    - [UX Enhancement Patterns](./implementation-patterns-consistency-rules.md#ux-enhancement-patterns)
    - [Audit Logging Pattern](./implementation-patterns-consistency-rules.md#audit-logging-pattern)
  - [Project Structure & Boundaries](./project-structure-boundaries.md)
    ...
    - [File Organization Summary](./project-structure-boundaries.md#file-organization-summary)
